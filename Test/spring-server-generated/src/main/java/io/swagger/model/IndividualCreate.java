...
import io.swagger.utils.DateTimeParser;
...
public class IndividualCreate   {
  ...
  **/
  ...
  public static IndividualCreate mapEntityToModel(IndividualDao individual){
    DateTimeParser birthTimeParser = new DateTimeParser();
    DateTimeParser deathTimeParser = new DateTimeParser();
    IndividualCreate dto = new IndividualCreate();
    dto.setId(individual.getId());
    dto.setHref(individual.getHref());
    dto.setAristocraticTitle(individual.getAristocraticTitle());
    dto.setBirthDate(birthTimeParser.parseFromSqlTimeStamp(individual.getBirthDate()));
    dto.setCountryOfBirth(individual.getCountryOfBirth());
    dto.setDeathDate(deathTimeParser.parseFromSqlTimeStamp(individual.getDeathDate()));
    dto.setFamilyName(individual.getFamilyName());
    dto.setFullName(individual.getFullName());
    dto.setGender(individual.getGender());
    dto.setBaseType(individual.getBaseType());
    dto.setSchemaLocation(individual.getSchemaLocation());
    dto.setType(individual.getType());

    return dto;
  }

  public static IndividualDao mapModelToEntity(IndividualCreate individual) {
    IndividualDao dao = new IndividualDao();
    dao.setId(individual.getId());
    dao.setHref(individual.getHref());
    dao.setAristocraticTitle(individual.getAristocraticTitle());
    dao.setBirthDate(dateTimeUtils.toSqlTimestamp(individual.getBirthDate().toLocalDateTime()));
    dao.setCountryOfBirth(individual.getCountryOfBirth());
    dao.setDeathDate(dateTimeUtils.toSqlTimestamp(individual.getDeathDate().toLocalDateTime()));
    dao.setFamilyName(individual.getFamilyName());
    dao.setFullName(individual.getFullName());
    dao.setGender(individual.getGender());
    dao.setBaseType(individual.getBaseType());
    dao.setSchemaLocation(individual.getSchemaLocation());
    dao.setType(individual.getType());
